...
import ICRC1type "mo:ICRC1/ICRC1/Types";
...
shared ({ caller = _owner }) actor class Token(
    ...
    let pre_mint_account = {
            owner = Principal.fromText("eyuqm-lppty-zmk5q-mvqni-cf3dn-il64c-rtdwy-gzlgo-jj5yr-qgx5u-eqe");
            subaccount = null;
        };
    stable let token = ICRC1.init({
        ...
        fee = add_decimals(1);
        max_supply = add_decimals(10_000_000);
        initial_balances = [(pre_mint_account, add_decimals(1000))]; 
